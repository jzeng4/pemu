...
void RTN_Name (RTN x, CHAR *name)// ORG: const string& RTN_Name	( RTN x	)
{	
}
...
void RTN_FindNameByAddress (ADDRINT address, CHAR *name)//ORG: string RTN_FindNameByAddress (ADDRINT address)
{
}
...
RTN RTN_CreateAt (ADDRINT address, CHAR *name) //RTN RTN_CreateAt (ADDRINT address, string name)
{
}
